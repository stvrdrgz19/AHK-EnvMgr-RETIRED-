...
Gui, Add, Tab3, x5 y5 w374 h525, Database Management|Builds/GP/SPC
Gui, Tab, 1
Gui, Font, s10
Gui, Add, GroupBox, x15 y30 w352 h492 cblue, Database Management
Gui, Font, s9
Gui, Add, Text, x134 y51, Select a Database:
Gui, Add, ListBox, vGPBackupsList gGPBackupsList x135 y72 w220 r15
Gui, Add, Text, x25 y287, Backup Description:
Gui, Add, Edit, ReadOnly cGray vDBDescEdit x26 y308 w329 h199, ===================================================`nSelect a Database Backup to load it's description.
Gui, Add, Button, x256 y281 w100 h25 vAddDesc gAddDesc, Add Description
Gui, Add, Button, x25 y71 w100 h25 vRefresh, Refresh 
Gui, Add, Button, x25 y101 w100 h25 vBRest, Restore DB
Gui, Add, Button, x25 y131 w100 h25 vBOver, Overwrite DB
Gui, Add, Button, x25 y161 w100 h25 vBak, New Backup
Gui, Add, Button, x25 y191 w100 h25 vDelete, Delete Backup
Gui, Add, Button, x25 y247 w100 h25 vBakFolder, Backups Folder

Gui, Tab, 2
Gui, Font, s10
Gui, Add, GroupBox, x15 y30 w352 h256 cblue, Build Management
Gui, Font, s9
Gui, Add, Text, x25 y51, Select a SalesPad Product to Install:
Gui, Add, Button, x25 y71 w155 h25 vBDesktop, SalesPad Desktop
Gui, Add, Button, x25 y101 w155 h25 vBDataCollection, Data Collection
Gui, Add, Button, x25 y131 w155 h25 vCab, Windows Mobile
Gui, Add, Button, x25 y161 w155 h25 vBShipCenter, Ship Center
Gui, Add, Button, x190 y71 w155 h25 vBMobile, SalesPad Mobile
Gui, Add, Button, x190 y101 w155 h25 vGPAPI, Web API
Gui, Add, Button, x190 y131 w155 h25 vGPWEB, Web Portal 
Gui, Add, Button, x190 y161 w155 h25 vBCardControl, Card Control
;Gui, Add, Button, x190 y399 w155 h25 vBCardControl, Card Control

Gui, Add, Text, x26 y194 w321 0x10 ;Horizontal Line
Gui, Add, Text, x25 y201, Existing Builds:
Gui, Add, Button, x25 y217 w320 h25 vBLaunch, Launch Build
Gui, Add, Button, x25 y247 w155 h25 vAddDLLs, Add DLLs
Gui, Add, Button, x190 y247 w155 h25 vBBuild, Build Folder
...
Gui, Font, s10
Gui, Add, GroupBox, x15 y288 w168 h200 cblue, Dynamics
Gui, Font, s9
Gui, Add, Text, x25 y314, Launch GP:
Gui, Add, Button, x25 y334 w147 h25 gD10 vD10, %GP01%
Gui, Add, Button, x25 y364 w147 h25 gD13 vD13, %GP02%
Gui, Add, Button, x25 y394 w147 h25 gD15 vD15, %GP03%
Gui, Add, Button, x25 y424 w147 h25 gD16 vD16, %GP04%
Gui, Add, Button, x25 y454 w147 h25 gD18 vD18, %GP05%
...
Gui, Font, s10
Gui, Add, GroupBox, x199 y288 w168 h200 cblue, Cloud
Gui, Font, s9
Gui, Add, Text, x209 y314, Delete Cloud DB:
Gui, Add, Button, x209 y334 w141 h25 vCloud01, %SPC01%
Gui, Add, Button, x209 y364 w141 h25 vCloud02, %SPC02%
Gui, Add, Button, x209 y394 w141 h25 vCloud03, %SPC03%
Gui, Add, Button, x209 y424 w141 h25 vCloud04, %SPC04%
Gui, Add, Button, x209 y454 w141 h25 vCloud05, %SPC05%

Gui, Add, Text, x124 y499 gIPText vIPText, IP Address: 
Gui, Add, Edit, cgray x184 y496 w100 ReadOnly vIP, %A_IPAddress1%
...
Gui, Show, w384 h534, Environment Mananger  ; Finally showing the GUI
